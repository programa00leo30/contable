	...
	function a(b,c){
		...
		function m(a,b){
			...
			return g(b,
				...
				g(a.buttons,
					function(a){
						if(d[a]===c)
							throw new Error("button key "+a+" is not allowed (options are "
								+b.join("\n")+")")}),a}
		var n={
		...
		p.prompt=function(){
			...
			if(f=b(n.form),d={
				...
				a.buttons.confirm.callback=function(){
					var c;
					switch(a.inputType){
						case"text":case"textarea":case"email":case"select":case"date":case"time":
						case"number":case"password":c=h.val();
						break;
						case"checkbox":
							var d=h.find("input:checked");
							c=[],
							g(d,function(a,d){c.push(b(d).val())})
						}
			...
			switch(h=b(n.inputs[a.inputType]),a.inputType){
				...
				case"password":h.val(a.value);break;
				case"select":
					var o={};
		...
		p.dialog=function(a){
			...
			if(
				g(j,
					function(a,b){
						k+="<button data-bb-handler='"+a+"' type='button' class='btn "
							+b.className+"'>"+b.label+"</button>",
						l[a]=b.callback}),
